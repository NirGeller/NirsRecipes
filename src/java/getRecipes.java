    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try{
                ...
                //try to login
                PreparedStatement stmt = con.prepareStatement("select * from recipes");
                ResultSet rs = stmt.executeQuery();
                String data = "";
                while(rs.next())
                    data += rs.getString("id") + '|' + rs.getString("title") + '|' + rs.getString("src") + '|' + rs.getString("description") + '|' + rs.getString("ETA") + '|' + rs.getString("servings") + '|' + rs.getString("steps") + ";";
                out.println(data);
